...
test_cases = [
    "[END] success=true steps=5 rewards=0,0.234,0.67,0.891,0.123",  # should PASS
    "[END] success=true steps=3 rewards=0.00,0,0.75",                  # should FAIL
    "[END] success=true steps=3 rewards=1.00,0,0.75",                  # should FAIL
