...
test_cases = [
    "[END] success=true steps=5 rewards=0,0.234,067,0.891,0.123",  # should PASS
    "[END] success=true steps=3 rewards=0.00,00,0.75",                  # should FAIL
    "[END] success=true steps=3 rewards=1.00,00,0.75",                  # should FAIL
